...
$pdo->exec("CREATE TABLE betrieb (id INTEGER PRIMARY KEY, firma TEXT, fusszeile TEXT, logo_mime TEXT, logo BLOB, qr_iban TEXT, qr_strasse TEXT, qr_hausnummer TEXT, qr_plz TEXT, qr_ort TEXT)");
...
$stmt->bindValue(4, $png1x1, PDO::PARAM_LOB);
$stmt->bindValue(5, $hatQr ? 'CH44 3199 9123 0008 8901 2' : null);
$stmt->bindValue(6, $hatQr ? 'Baslerstrasse' : null);
$stmt->bindValue(7, $hatQr ? '67' : null);
$stmt->bindValue(8, $hatQr ? '4632' : null);
$stmt->bindValue(9, $hatQr ? 'Trimbach' : null);
$stmt->execute();

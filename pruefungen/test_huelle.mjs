...
try {
  ...
  // Der Vergleich braucht zwei WIRKLICH verschieden breite Leisten -- sonst
  // belegt er nichts. Bis ENT-421 waren das Kunden (fuenf) und
  // Administration (drei); seit "Mitteilungen" dazukam, sind die beiden
  // fast gleich breit (414 gegen 413 px gemessen). Die Planung ist mit
  // kuerzeren Namen deutlich schmaler und uebernimmt diese Rolle.
  check('Und die Leisten sind wirklich verschieden breit',
    Math.abs(mKunden.breite - mPlanung.breite) > 20);
